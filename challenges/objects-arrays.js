...
const displayNames = [];
let nameNames = zooAnimals.forEach(function(i){
...
*/
const populationTotal = zooAnimals.reduce((populationTotal, populationNumber) => {
  return populationTotal + populationNumber.population;}, 0)
